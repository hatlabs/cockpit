...
import { LockIcon, WifiIcon, OutlinedQuestionCircleIcon } from '@patternfly/react-icons';
...
/**
 * Saved network item with controls
 */
const WiFiSavedNetworkItem = ({
    ...
    const ssid = settings?.wifi?.ssid ||
                 settings?.["802-11-wireless"]?.ssid?.v ||
